...
# terminal programs
brew install stow
stow --target=$HOME ~/.dotfiles.git/main
brew install neovim
brew install fzf
brew install tmux
...
defaults write com.apple.finder FXEnableExtensionChangeWarning -boolean false; killall Finder;
...
sudo systemsetup -settimezone "Europe/Germany" > /dev/null
